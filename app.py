...
# Clean resume==========================================================================================================
def cleanResume(txt):
    cleanText = re.sub(r'\(cid:\d{1,3}\)', ' ', txt)
...
def score_resume(resume_text):
    ...
    if 'objective' in resume_text:
        resume_score += 20
        recommendations.append("[+] Great! You have included your Objective.")
    else:
        recommendations.append("[-] Please add a career Objective to showcase your career intent.")

    if 'extracurricular' in resume_text:
        resume_score += 20
        recommendations.append("[+] Great! You have included a Declaration.")
    else:
        recommendations.append("[-] Please add a Declaration for authenticity.")

    if any(section in resume_text for section in ['Hobbies', 'Interests']):
        resume_score += 20
        recommendations.append("[+] Great! You have added Hobbies or Interests.")
    else:
        recommendations.append("[-] Consider adding Hobbies or Interests to reflect your personality.")

    if 'achievements' in resume_text:
        resume_score += 20
        recommendations.append("[+] Great! You have added Achievements.")
    else:
        recommendations.append("[-] Please add Achievements to highlight your capabilities.")

    if 'projects' in resume_text:
        resume_score += 20
        recommendations.append("[+] Great! You have added Projects.")
    else:
        recommendations.append("[-] Please add Projects to demonstrate relevant experience.")
...
def pred():
    if 'resume' in request.files:
        ...
        if filename.endswith('.pdf'):
            ...
            return render_template('resume.html',message="Invaild file format")
        ...
        resume_score, recommendations = score_resume(text)
        ...
        return render_template('resume.html', predicted_category=predicted_category,recommended_job=recommended_job,
                               ...
                               resume_score=resume_score,  recommendations=recommendations, )
    else:
